...
export const JewelleryEditSection: React.FC = () => {
  ...
  return (
    <section className="py-10 sm:py-16 md:py-20 relative bg-[#07070a] overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 sm:mb-8 md:mb-10 gap-6">
          <div>
        ...
        {/* Bottom CTA Banner */}
        <div className="mt-8 sm:mt-10 p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-black via-[#121218] to-black border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
